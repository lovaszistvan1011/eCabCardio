...
<!-- Bootstrap -->
<link href="/appearance/css/bootstrap.min.css" rel="stylesheet">
<!-- style css -->
<link rel="stylesheet" type="text/css" href="/appearance/css/style.css">
<!-- animsition css -->
<link rel="stylesheet" type="text/css" href="/appearance/css/animsition.min.css">
<!-- Font Awesome CSS -->
...
<div class="top-header"><!-- top header -->
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-12"><a class="logo" href="index.html"><img src="/appearance/images/logo.png" alt=""></a> </div>
      <div class="col-md-9 hidden-sm hidden-xs">
        <div class="top-link">
          <div class="row">
            <div class="col-md-6">
              <i class="fa fa-clock-o"></i>Luni - Vineri: <br>10:00 - 18:00
            </div>
            <div class="col-md-3">
              <i class="fa fa-phone"></i> <a href="cantact-us.html">+91 123 4567 789</a>
            </div>
            <div class="col-md-3">
              <i class="fa fa-envelope-o"></i> <a href="cantact-us.html">info@cardio.com</a>
            </div>
          </div>
        </div>
      </div>
